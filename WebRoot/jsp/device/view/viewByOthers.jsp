											...
											<TBODY>
												...
												<c:forEach items="${pageBean.listDevices }" var="device">
													<TR
														...
														<TD><A
															href="${pageContext.request.contextPath }/device_viewByDidByOthers.action?did=${device.did }">查看</A>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1}">
												  [<A
															href="${pageContext.request.contextPath }/device_listByOthers.action?currentPage=${pageBean.currentPage-1 }">前一页</A>]
												</c:if>
													<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
												  [<A
															href="${pageContext.request.contextPath }/device_listByOthers.action?currentPage=${pageBean.currentPage+1 }">后一页</A>]
												</c:if>
												</c:if>
