							...
							<TBODY>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN>设备中心</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/device_toAddPage.action"
														target=main>－ 添加信息</A>
													</TD>
												</TR>
												<TR>
												...
												<%-- <TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/device_delete.action?"
														target=main>－ 一键删除</A>
													</TD>
												</TR> --%>
												<TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
										class=span id=table_4Span>＋</SPAN> 项目中心</TD>
								</TR>
								<TR>
									<TD>
