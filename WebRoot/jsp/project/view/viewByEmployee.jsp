											...
											<TBODY>
												...
												<c:forEach items="${pageBean.listProjects }" var="project">
													<TR
														...
														<TD><A
															href="${pageContext.request.contextPath }/project_viewByPnumberByEmployee.action?pnumber=${project.pnumber }">查看</A>
														</TD>
													</TR>
												</c:forEach>
											</TBODY>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1}">
												  [<A
															href="${pageContext.request.contextPath }/project_list.action?currentPage=${pageBean.currentPage-1 }">前一页</A>]
												</c:if>
													<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
												  [<A
															href="${pageContext.request.contextPath }/project_list.action?currentPage=${pageBean.currentPage+1 }">后一页</A>]
												</c:if>
												</c:if>
