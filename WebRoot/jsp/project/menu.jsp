							...
							<TBODY>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/project_toAddPage.action"
														target=main>－ 添加项目</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/project_listByUnumber.action?currentPage=1"
														target=main>－ 项目列表</A>
													</TD>
												</TR>
												<%-- <TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/project_delete.action"
														target=main>－ 删除项目</A>
													</TD>
												</TR> --%>
												<TR>
									...
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/support_listByOthers.action?currentPage=1"
														target=main>－ 支援列表</A>
													</TD>
												</TR>
											</TBODY>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> 设备中心</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_7');"><SPAN
										class=span id=table_7Span>＋</SPAN>公告中心</TD>
								</TR>
								<TR>
									<TD>
