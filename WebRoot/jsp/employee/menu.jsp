							...
							<TBODY>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/employee_selfInfo.action"
														target=main>－个人信息</A>
													</TD>
												</TR>
												<%-- <TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_3');"><SPAN
										class=span id=table_3Span>＋</SPAN> 支援信息</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/support_toAddPage.action?"
														target=main>－ 添加支援</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/support_listByEmployee.action?currentPage=1"
														target=main>－ 支援列表</A>
													</TD>
												</TR>
												<%-- <TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/support_delete.action"
														target=main>－ 删除支援</A></TD>
												</TR> --%>
											</TBODY>
										</TABLE></TD>
								</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
										class=span id=table_4Span>＋</SPAN> 通讯录</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/employee_listByOthers.action?currentPage=1"
														target=main>－ 通讯录列表</A>
													</TD>
												</TR>
											</TBODY>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> 工业中心</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
										class=span id=table_6Span>＋</SPAN> 设备中心</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
