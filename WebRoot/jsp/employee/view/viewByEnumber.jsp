...
<BODY>
	<FORM id=form1 name=form1 action="" method=post>
        <input type="hidden" name="epwd" id="epwd" value="${employee.epwd }"/>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：通讯录 &gt; 通讯录信息</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<tr>
								...
								<td><INPUT type="date" style="WIDTH: 180px" maxLength=100
									name="edate" id="edate" value="${employee.edate }" />
								</td>
							</tr>
							<tr>
								<td>院校：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="eschool" id="eschool" value="${employee.eschool }" />
								</td>
								<td>学历：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=100
									name="educ" id="educ"  value="${employee.educ }"/>
								</td>
								<td>*身份证：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=100
									name="eids" id="eids" value="${employee.eids }"/>
								</td>
							</tr>
							<tr>
