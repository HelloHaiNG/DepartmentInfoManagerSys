											...
											<TBODY>
												...
												<c:forEach items="${pageBean.listEmployees }" var="employee">
													<TR
														...
														<TD>${employee.epwd }</TD>
														<TD><A
															href="${pageContext.request.contextPath }/employee_viewByEnumber.action?enumber=${employee.enumber }">查看</A>
															
														</TD>
														<TD><input id="report" name="report"
															value=${ employee.enumber} onclick="check()"
															type="checkbox" />
														</TD>
														<td><A
															href="${pageContext.request.contextPath }/employee_deleteByEnumber.action?enumber=${employee.enumber }">删除</A>
														</td>
													</TR>
												</c:forEach>
											</TBODY>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1}">
												  [<A
														href="${pageContext.request.contextPath }/employee_list.action?currentPage=${pageBean.currentPage-1 }">前一页</A>]
												</c:if>
												<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
												  [<A
														href="${pageContext.request.contextPath }employee_list.action?currentPage=${pageBean.currentPage+1 }">后一页</A>]
												</c:if>
												</c:if>
