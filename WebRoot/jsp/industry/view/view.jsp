											...
											<TBODY>
												...
												<c:forEach items="${pageBean.listIndustries }"
													...
													<TR
														...
														<TD><A
															href="${pageContext.request.contextPath }/industry_viewById.action?id=${industry.id }">查看</A>
															
														</TD>
														<TD><input id="report" name="report"
															value=${ industry.id} onclick="check()" type="checkbox" />
														</TD>
														<td><A
															href="${pageContext.request.contextPath }/industry_deleteById.action?id=${industry.id }">删除</A>
														</td>
													</TR>
												</c:forEach>
											</TBODY>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1}">
												  [<A
															href="${pageContext.request.contextPath }/industry_list.action?currentPage=${pageBean.currentPage-1 }">前一页</A>]
												</c:if>
													<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
												  [<A
															href="${pageContext.request.contextPath }/industry_list.action?currentPage=${pageBean.currentPage+1 }">后一页</A>]
												</c:if>
												</c:if>
