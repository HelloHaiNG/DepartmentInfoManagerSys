...
<script type="text/javascript">
	function check() {
		...
		window.location.href = "/ProManaPlatForm/support_update.action?sstime="
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<tr>
								...
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									...
									value="${support.sprojectnumber }" />
								</td>
								<td>*项目名称：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="sprojectname" id="sprojectname"
									value="${support.sprojectname }" />
								</td>
								<td>支援类型：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="skind" id="skind" value="${support.skind }" /></td>
								<td>问题：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
							...
							<tr>
								...
								<td>状态：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=100
									name="status" id="status" value="${support.status }" /></td>
							</tr>
							<tr>
								<td>支援时间说明：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
								...
								<td>*收费标准：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="standardcharge" id="standardcharge" readonly="readonly"
									value="${support.standardcharge }" />
								</td>
								<td>*实际收费：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="srealitycharge" id="srealitycharge" readonly="readonly"
									value="${support.srealitycharge }" />
								</td>
							</tr>
							<tr>
							   <td>*超时收费标准：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="soverstandardcharge" id="soverstandardcharge" readonly="readonly"
									value="${support.soverstandardcharge }" />
								</td>
								<td>*实际超时收费：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="srealityovercharge" id="srealityovercharge" readonly="readonly"
									value="${support.srealityovercharge }" />
								</td>
								<td>*费用是否结算：</td>
								<td><INPUT class=textbox style="WIDTH: 180px" maxLength=50
									name="sisclosecharge" id="sisclosecharge" readonly="readonly"
									value="${support.sisclosecharge }" />
								</td>
							</tr>
						</TABLE>
					</TD>
