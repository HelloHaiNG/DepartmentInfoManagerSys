											...
											<TBODY>
												...
												<c:forEach items="${pageBean.listSupports }" var="support">
													<TR
														...
														<TD>${support.stime }</TD>
														<TD><A
															href="${pageContext.request.contextPath }/support_viewBySidByAdmin.action?sid=${support.sid }">查看</A>
														</TD>
													</TR>
												</c:forEach>
											</TBODY>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1}">
												  [<A
															href="${pageContext.request.contextPath }/supprot_list.action?currentPage=${pageBean.currentPage-1 }">前一页</A>]
												</c:if>
													<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
												  [<A
															href="${pageContext.request.contextPath }/supprot_list.action?currentPage=${pageBean.currentPage+1 }">后一页</A>]
												</c:if>
												</c:if>
