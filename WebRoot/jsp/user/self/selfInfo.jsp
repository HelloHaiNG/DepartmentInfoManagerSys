						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<TR>
								...
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 readonly="true" name="unumber"
									value=${user.unumber } /></td>
								<td>姓名：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 readonly="true" name="username"
									value=${user.username } /></td>
								<td>密码：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 readonly="true" name="upwd" value=${user.upwd } />
							</TR>
						</TABLE></TD>
					<TD width=15
